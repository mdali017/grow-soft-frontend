          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <h1 style={{ fontFamily: "title_font" }} className="text-4xl">
                  Grow Soft
                </h1>

                <div className="hidden ms-32 md:block   sm:w-[400px]">
      ...
      <Container>
        <div className="py-3 mt-3 -mx-3 overflow-y-auto whitespace-nowrap scroll-hidden ">
          {categoryItem.map((item) => (
            <a
              key={item}
              className="mx-4 text-sm leading-5 text-white transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:my-0"
              href="#"
            >
              {item}
            </a>
